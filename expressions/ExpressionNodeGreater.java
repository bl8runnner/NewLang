...
public class ExpressionNodeGreater extends ExpressionNodeTwoOps
{
    private final static String IDENTIFIER = ">";

    public static ExpressionNodeGreater create(final Expressions expressions) throws Exception
    {
    ...
    public static ExpressionNodeGreater create(final Node left, final Node right) throws Exception
    {
        try
        {
            return new ExpressionNodeGreater(left, right);
        }
    ...
    private ExpressionNodeGreater(final Node left, final Node right) throws Exception
    {
