...
public class ExpressionNodeMul extends ExpressionNodeTwoOps
{
    private final static String IDENTIFIER = "*";

    public static ExpressionNodeMul create(final Expressions expressions) throws Exception
    {
    ...
    public static ExpressionNodeMul create(final Node left, final Node right) throws Exception
    {
        try
        {
            return new ExpressionNodeMul(left, right);
        }
    ...
    private ExpressionNodeMul(final Node left, final Node right) throws Exception
    {
