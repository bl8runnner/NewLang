...
public class ExpressionNodeLessEqual extends ExpressionNodeTwoOps
{
    private final static String IDENTIFIER = "<=";

    public static ExpressionNodeLessEqual create(final Expressions expressions) throws Exception
    {
    ...
    public static ExpressionNodeLessEqual create(final Node left, final Node right) throws Exception
    {
        try
        {
            return new ExpressionNodeLessEqual(left, right);
        }
    ...
    private ExpressionNodeLessEqual(final Node left, final Node right) throws Exception
    {
