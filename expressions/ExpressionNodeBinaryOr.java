...
public class ExpressionNodeBinaryOr extends ExpressionNodeTwoOps
{
    private final static String IDENTIFIER = "|";

    public static ExpressionNodeBinaryOr create(final Expressions expressions) throws Exception
    {
    ...
    public static ExpressionNodeBinaryOr create(final Node left, final Node right) throws Exception
    {
        try
        {
            return new ExpressionNodeBinaryOr(left, right);
        }
    ...
    private ExpressionNodeBinaryOr(final Node left, final Node right) throws Exception
    {
