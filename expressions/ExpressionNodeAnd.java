...
public class ExpressionNodeAnd extends ExpressionNodeTwoOps
{
    private final static String IDENTIFIER = "&&";

    public static ExpressionNodeAnd create(final Expressions expressions) throws Exception
    {
    ...
    public static ExpressionNodeAnd create(final Node left, final Node right) throws Exception
    {
        try
        {
            return new ExpressionNodeAnd(left, right);
        }
    ...
    private ExpressionNodeAnd(final Node left, final Node right) throws Exception
    {
