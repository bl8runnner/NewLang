...
public class ExpressionNodeOr extends ExpressionNodeTwoOps
{
    private final static String IDENTIFIER = "||";

    public static ExpressionNodeOr create(final Expressions expressions) throws Exception
    {
    ...
    public static ExpressionNodeOr create(final Node left, final Node right) throws Exception
    {
        try
        {
            return new ExpressionNodeOr(left, right);
        }
    ...
    private ExpressionNodeOr(final Node left, final Node right) throws Exception
    {
