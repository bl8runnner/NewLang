...
public class ExpressionNodePointer extends ExpressionNodeTwoOps
{
    private final static String IDENTIFIER = "^";

    public static ExpressionNodePointer create(final Expressions expressions) throws Exception
    {
    ...
    public static ExpressionNodePointer create(final Node left, final Node right) throws Exception
    {
        try
        {
            return new ExpressionNodePointer(left, right);
        }
    ...
    private ExpressionNodePointer(final Node left, final Node right) throws Exception
    {
