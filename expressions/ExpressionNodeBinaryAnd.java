...
public class ExpressionNodeBinaryAnd extends ExpressionNodeTwoOps
{
    private final static String IDENTIFIER = "&";

    public static ExpressionNodeBinaryAnd create(final Expressions expressions) throws Exception
    {
    ...
    public static ExpressionNodeBinaryAnd create(final Node left, final Node right) throws Exception
    {
        try
        {
            return new ExpressionNodeBinaryAnd(left, right);
        }
    ...
    private ExpressionNodeBinaryAnd(final Node left, final Node right) throws Exception
    {
