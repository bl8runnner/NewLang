...
public class ExpressionNodeGreaterEqual extends ExpressionNodeTwoOps
{
    private final static String IDENTIFIER = ">=";

    public static ExpressionNodeGreaterEqual create(final Expressions expressions) throws Exception
    {
    ...
    public static ExpressionNodeGreaterEqual create(final Node left, final Node right) throws Exception
    {
        try
        {
            return new ExpressionNodeGreaterEqual(left, right);
        }
    ...
    private ExpressionNodeGreaterEqual(final Node left, final Node right) throws Exception
    {
