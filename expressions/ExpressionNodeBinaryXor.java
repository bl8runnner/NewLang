...
public class ExpressionNodeBinaryXor extends ExpressionNodeTwoOps
{
    private final static String IDENTIFIER = "^";

    public static ExpressionNodeBinaryXor create(final Expressions expressions) throws Exception
    {
    ...
    public static ExpressionNodeBinaryXor create(final Node left, final Node right) throws Exception
    {
        try
        {
            return new ExpressionNodeBinaryXor(left, right);
        }
    ...
    public ExpressionNodeBinaryXor(final Node left, final Node right) throws Exception
    {
