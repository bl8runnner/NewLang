...
public class ExpressionNodeXor extends ExpressionNodeTwoOps
{
    private final static String IDENTIFIER = "^^";

    public static ExpressionNodeXor create(final Expressions expressions) throws Exception
    {
    ...
    public static ExpressionNodeXor create(final Node left, final Node right) throws Exception
    {
        try
        {
            return new ExpressionNodeXor(left, right);
        }
    ...
    private ExpressionNodeXor(final Node left, final Node right) throws Exception
    {
