...
public class ExpressionNodeSub extends ExpressionNodeTwoOps
{
    private final static String IDENTIFIER = "-";

    public static ExpressionNodeSub create(final Expressions expressions) throws Exception
    {
    ...
    public static ExpressionNodeSub create(final Node left, final Node right) throws Exception
    {
        try
        {
            return new ExpressionNodeSub(left, right);
        }
    ...
    private ExpressionNodeSub(final Node left, final Node right) throws Exception
    {
