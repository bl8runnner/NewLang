...
public class ExpressionNodeColon extends ExpressionNodeTwoOps
{
    private final static String IDENTIFIER = ":";

    public static ExpressionNodeColon create(final Expressions expressions) throws Exception
    {
    ...
    public static ExpressionNodeColon create(final Node left, final Node right) throws Exception
    {
        try
        {
            return new ExpressionNodeColon(left, right);
        }
    ...
    private ExpressionNodeColon(final Node left, final Node right) throws Exception
    {
